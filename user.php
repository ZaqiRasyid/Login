  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse mt-2" id="navbarNavAltMarkup">
      <div class="navbar-nav me-auto">
       <a href="game.php" class="btn btn-outline-primary m-1">Game</a>
       <a href="scores.php" class="btn btn-outline-primary m-1">Scores</a>
       <a href="token.php" class="btn btn-outline-primary m-1">Token</a>
